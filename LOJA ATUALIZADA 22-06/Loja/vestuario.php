...
$dbname = "produtos";
 try {
	    ...
	    // forma 1
		$select = $conn->query("SELECT * FROM produtos where CategoriaProduto='Vestuario' ");
...
$result_produtos = "SELECT * FROM produtos where CategoriaProduto='Vestuario' ";
...
$result_produtos = "SELECT * FROM produtos where CategoriaProduto='Vestuario' limit $incio, $quantidade_pg";
$resultado_produtos = mysqli_query($conn, $result_produtos);
$total_produtos = mysqli_num_rows($resultado_produtos);
?>
				...
				<ul class="pagination">
					<li>
						...
						if($pagina_anterior != 0){ ?>
							<a href="vestuario.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
					...
					for($i = 1; $i < $num_pagina + 1; $i++){ ?>
						<li><a href="vestuario.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php } ?>
					<li>
						<?php
						if($pagina_posterior <= $num_pagina){ ?>
							<a href="vestuario.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
