...
$dbname = "produtos";
 try {
	    ...
	    // forma 1
		$stmt = $conn->prepare("SELECT * FROM produtos WHERE idProdutos=:id;");
    ...
    <button onclick="topFunction()" id="myBtn" title="Go to top"><i class="up"></i></button>  
          ...
          <form class="modal-content animate" action="alterar.php" method="POST" enctype="multipart/form-data">
           ...
           <input type="hidden" name="idProdutos" value="<?php echo $result['idProdutos']; ?>">
            ...
            <label><h1>Nome do Produto</h1></label>
              <input type="text" placeholder="Digite o nome do produto..." maxlength="20" name="NomeProduto" value="<?php echo $result['NomeProduto'];?> " required>             
             
              <label><h1>Nome da Categoria</h1></label>
              <select name="CategoriaProduto" value="<?php echo $result['CategoriaProduto'];?>"> 
              ...
              <select name="CorProduto" value="<?php echo $result['CorProduto'];?>"> 
              ...
              <select name="TamanhoProduto" value="<?php echo $result['TamanhoProduto'];?>">
              ...
              <input type="text" placeholder="Digite o preço do produto... como no exemplo: 49.00" name="PrecoProduto" maxlength="7" value="<?php echo $result['PrecoProduto'];?>" required>
              <br>
                <label><h1>Disponibilidade do Produto</h1></label>
              <input type="text" placeholder="Informe se o produto está disponível no estoque ou se está esgotado!" name="DisponibilidadeProduto" maxlength="20" value="<?php echo $result['DisponibilidadeProduto'];?>" required>
               <br>
                <label><h1>Quantidade de Produtos</h1></label>
              <input type="text" placeholder="Informe a quantidades de produtos disponiveis" name="QuantidadeProduto" maxlength="5"  value="<?php echo $result['QuantidadeProduto'];?>"required>
              <br>
              <label><h1>Descrição dos Produtos</h1></label>
                 <textarea class="form-control" name="DescricaoProduto" placeholder="Digite Aqui ... " maxlength="250" required><?php echo $result['DescricaoProduto'];?></textarea>   
