...
$result_produtos = "SELECT * FROM produtos where NomeProduto LIKE '%$valor_pesquisar%' ";
...
$result_produtos = "SELECT * FROM produtos where NomeProduto LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
$resultado_produtos = mysqli_query($conn, $result_produtos);
$total_produtos = mysqli_num_rows($resultado_produtos);
?>
...
<html>
    ...
    <button onclick="topFunction()" id="myBtn" title="Go to top"><i class="up"></i></button>  
       ...
       <div class="page-header text-center">
           <h1><?php echo 'Procurando por :'.$valor_pesquisar ?></h1>
       </div>
        <div class="row">
